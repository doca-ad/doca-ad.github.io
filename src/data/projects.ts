...
import project2_6 from "@/assets/02/6.jpg";
...
export const projects: Project[] = [
	...
	},
	{
		...
		type: "Interior Design / Residential",
		title: "HIDEOUT",
		description: "Conceived as a sanctuary above the everyday, the project transforms the attic of a Bucharest residence into a serene refuge — a space where time seems to slow, and the noise of daily life fades away. Light becomes the defining element of this interior. To amplify the natural illumination from the two skylights, the design introduces a series of transparent and translucent interventions — a glazed door and two matching interior windows that allow sunlight to filter softly from the stairwell into the heart of the attic. The artificial lighting is layered and versatile, designed to adapt to the evolving rhythms of the day and the multiple moods of the space. The existing wooden structure is preserved and celebrated, its restored beams and textures anchoring the design in authenticity. These tactile, time-worn elements enrich the atmosphere with warmth and intimacy, shaping a cocoon-like environment that is both contemporary and deeply familiar.",
		images: [
			{
				id: "arch-1",
				url: project6_1,
		...
		type: "Architecture / Residential",
		title: "THE NEST",
		description: "The nest represents nature’s purest form of shelter — a structure both protective and nurturing. In this project, the concept of the nest is reinterpreted as a naturally evolving, dynamic volume, born from the assembly of multiple modular units. Through this interpretation emerges the idea of the “Nest House”, an architectural composition that embodies both organic growth and structural harmony. The proposal consists of six distinct volumes, each designed as an independent entity, orbiting around a central axis — the inner courtyard. Positioned at the heart of the composition, this courtyard becomes the metaphorical interior of the nest, a sheltered and protected space. The very first encounter with this courtyard conveys the architectural essence of the project — a balance between openness and refuge, between exposure and intimacy. A second dimension of the “Nest” concept is revealed through the towering volume that houses both the master bedroom — the residence’s only sleeping area — and a private study. The placement of the study at the highest point of the house symbolizes a broader perspective, both literally and metaphorically. It is conceived as a place of retreat, a vantage point from which one can observe without being observed, a space of contemplation and protection. Its proximity to the bedroom reinforces the intimate and personal nature of this elevated realm. The choice of materials further deepens the conceptual narrative. Wood, one of humanity’s earliest building materials, evokes both familiarity and safety. Its use as the primary architectural material emphasizes the project’s natural essence and the simplicity inherent in the idea of a nest, while showcasing the complexity and coherence achieved through the interlocking of its modular components. A careful balance between solid and glazed surfaces ensures a clear yet fluid boundary between interior and exterior. Through the deliberate orientation of the volumes and openings, the interior space maintains a dialogue with its surroundings, rather than existing in isolation. This continuous exchange between inside and outside",
		images: [
			{
				id: "arch-1",
				url: project7_1,
